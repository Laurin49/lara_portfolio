    ...
    <div class="py-12">
        <div class="max-w-md mx-auto bg-white rounded-md shadow-md sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('projects.store') }}" class="p-4" enctype="multipart/form-data">
                ...
                <label for="skill_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Select Skill</label>
                ...
                <div class="mt-2">
                    ...
                    <x-text-input id="project_url" class="block w-full mt-1" type="text" name="project_url"
